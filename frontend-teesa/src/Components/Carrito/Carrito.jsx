...
import { updateCart, deleteCart } from '../../features/reduxReducer/carritoSlice';
// import Cart from './Cart';
// import Card from '../Card/Card';

export const Carrito = ({ id, cantidad, precioTotal, nombre, precio, imagen }) => {
    const options = {
        style: 'decimal',
        useGrouping: true,
    ...
    const handleIncrement = (e) => {
      e.preventDefault();
        ...
        .then(() => {
          ...
          .catch((error) => {
            console.error('Error al aumentar la cantidad del producto del carrito:', error);
          });
      };
      ...
      const handleDecrement = (e) => {
        ...
        .then(() => {
          ...
          .catch((error) => {
            console.error('Error al disminuir la cantidad del producto del carrito:', error);
          });
      };
      ...
      return (
        ...
        <img className="w-40 h-36 object-cover rounded-lg" src={imagen[0]} alt={nombre} />
        <div className="ml-4">
          ...
          <div className="flex items-center mt-2">
            ...
            <span id="quantity" className="px-2 text-gray-700">
              {cart.cantidad}
            </span>
            <button
              type="button"
