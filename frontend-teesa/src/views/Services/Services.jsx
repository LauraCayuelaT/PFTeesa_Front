...
function Services() {
  return (
    <div className='flex flex-col justify-center items-center bg-blue-100'>
      <h1 className='text-teesaBlueDark font-bold mt-[2%] mb-[2%] xl:text-5xl lg:text-5xl md:text-4xl sm:text-4xl '>
        Servicios
      </h1>
      <div className='flex flex-grow flex-row justify-center items-center gap-[10%] mb-[3%] text-center'>
        <div className='w-[25%] h-[40%] bg-teesaBlueDark flex flex-col justify-center items-center rounded-lg'>
          <img
            src={preventivo}
            alt='prev'
            className='border-4 border-teesaBlueDark rounded-lg'
          />
          <p className='text-teesaWhite mt-[2%] xl:text-xl lg:text-xl md:text-sm sm:text-sm mb-[2%]'>
