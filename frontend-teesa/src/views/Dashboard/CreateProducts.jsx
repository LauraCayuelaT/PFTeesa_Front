...
const selectedFileRef = useRef([]);
  ...
  >
    ...
    <div className="h-[5px]"></div>
        ...
        {/* caracteriticas */}
        <label className="flex flex-col justify-center align-center items-center ">
                <input type="text" name="caracteristicas" placeholder=' Caracteristicas' className="bg-teesaBlueDark text-teesaGrey rounded-md h-[2em] w-[15em]" {...register('caracteristicas', { 
                  required: 'Este campo es obligatorio',
                  pattern: {
                    value: /^[a-zA-Z\s]+$/,
                    message: 'Solo se aceptan letras y espacios',
              ...
              {errors.caracteristicas ? (
                <span className='text-red-500'>{errors.caracteristicas.message}</span>
              ) : (
                <div className='h-[5px]'></div>
              )}
        </label>
        {/* categoria */}
        <label className="flex flex-col justify-center align-center items-center ">
                <input type="text" name="categoria" placeholder=' Categoria' className="bg-teesaBlueDark text-teesaGrey rounded-md h-[2em] w-[15em]" {...register('categoria', { 
                  required: 'Este campo es obligatorio',
                  pattern: {
                    value: /^[a-zA-Z\s]+$/,
                    message: 'Solo se aceptan letras y espacios',
        ...
        {/* precio */}
        <label className="flex flex-col justify-center align-center items-center ">
                <input type="number" name="precio" placeholder=' Precio' className="bg-teesaBlueDark text-teesaGrey rounded-md h-[2em] w-[15em]" {...register('precio', { 
                  required: 'Este campo es obligatorio',
                  pattern: {
                    value: /^\d+(\.\d{1,2})?$/,
        ...
        {/* stock */}
        <label className="flex flex-col justify-center align-center items-center ">
                <input type="number" name="stock" placeholder=' Stock' className="bg-teesaBlueDark text-teesaGrey rounded-md h-[2em] w-[15em]" {...register('stock', { 
            required: 'Este campo es obligatorio',
            pattern: {
              value: /^\d+(\.\d{1,2})?$/,
  ...
  {errors.marca ? (
    ...
    <div className="h-[5px]"></div>
        ...
        {/* descripcion */}
        <label className="flex flex-col justify-center align-center items-center ">
                <input type="text" name="descripcion" placeholder=' Descripción' className="bg-teesaBlueDark text-teesaGrey rounded-md h-[2em] w-[15em]" {...register('descripcion', { 
                  required: 'Este campo es obligatorio',
                  pattern: {
                    value: /^[a-zA-Z\s]+$/,
                    message: 'Solo se aceptan letras y espacios',
        ...
        {/* ref */}
        <label className="flex flex-col justify-center align-center items-center ">
                <input type="text" name="ref" placeholder=' Referencia' className="bg-teesaBlueDark text-teesaGrey rounded-md h-[2em] w-[15em]" {...register('ref')}
